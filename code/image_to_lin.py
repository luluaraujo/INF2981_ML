...
def image_to_lin(image_file, export_as_ndvi):
    ...
    return metadados, linha_pixel, linha_stat, ndvi

#=================INICIO da BAGAÇA========================================

PATH_DATASET = '/Users/user/Documents/Mestrado/INF2981_ML_II/projeto/dataset'
pasta_tif = PATH_DATASET + '/test-tif-v2/test/' #pasta onde estão as imagens, deve terminar com //
pasta_result = PATH_DATASET + '/test-tif-v2/test/result/'
...
for file in lista_tif:
    ...
    try:
        ...
        metadados, linha_pixel, linha_stat, nv = image_to_lin(path, True)
